...
public:
    ...
    */
    ...
    void DisplayDialogMachine(wxWindow* parent, int machineNum);

    /**
     * Setting machine 1
     * @param machine1
     */
    void SetMachine1(std::shared_ptr<MachineAdapter> machine1){mMachine1 = machine1;}

    /**
     * Setting machine 2
     * @param machine2
     */
    void SetMachine2(std::shared_ptr<MachineAdapter> machine2){mMachine2 = machine2;}
